  ...
  hi: {
    translation: {
      ...
      hero: {
        ...
        cta2: "सभी ऋण देखें",
        stat1Value: "8.25%",
        stat1Label: "न्यूनतम ब्याज दर",
        stat2Value: "₹200 करोड़+",
        stat2Label: "वितरित ऋण",
        stat3Value: "24 घंटे",
        stat3Label: "औसत मंजूरी समय"
      },
      products: {
      ...
      trust: {
        ...
        description: "हर संख्या एक सशक्त परिवार, एक शुरू हुआ व्यवसाय और एक पूरा हुआ सपना दर्शाती है। हम सफलता को बदलते हुए जीवनों में मापते हैं।"
      },
      calculator: {
        eyebrow: "EMI कैलकुलेटर",
        titleStart: "अपनी प्रतिबद्धता की योजना बनाएं,",
        titleAccent: "प्रतिबद्ध",
        titleEnd: "होने से पहले।",
      ...
      testimonials: {
        eyebrow: "प्रशंसापत्र",
        titleStart: "भारत के",
        titleAccent: "उधारकर्ताओं",
        titleEnd: "की कहानियाँ।",
        items: [
      ...
      aboutPage: {
        ...
        titleStart: "भीलवाड़ा में जन्मे। भारत की",
        titleAccent: "रीढ़",
        titleEnd: "के लिए बने।",
        subtitle: "2016 से अर्णव फिनकॉर्प चुपचाप राजस्थान के दिल को ऋण देने का तरीक़ा बदल रहा है। हम भीलवाड़ा के वस्त्र व्यापारियों, आसपास के मंडी कस्बों के दुकानदारों, और उन पहली पीढ़ी के उधारकर्ताओं को वित्त देते हैं जिनकी ज़िम्मेदारी कोई मेट्रो बैंक उठाने को तैयार नहीं। नवकार प्लाज़ा, हरि सेवा मार्ग स्थित हमारे मुख्यालय से शुरू होकर हम आज राजस्थान की तीन शाखाओं तक पहुँच चुके हैं — और 1,800 से अधिक परिवारों को ₹200 करोड़ से ज़्यादा वितरित कर चुके हैं। इस सफ़र के हर अध्याय में एक वादा नहीं बदला: नकदी प्रवाह वास्तविक है, चरित्र सत्यापन योग्य है, और जिस भारत ने इंडिया को बनाया, वह अपनी शर्तों पर ऋण का हक़दार है।",
